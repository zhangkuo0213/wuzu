...
<section class="hotChannel pubItem">
	<ul class="clearfix">
		...
		<li>
			<a href="<?php echo url('home/Index/plan'); ?>">
				<img src="__PUBLIC__/picture/icon_main_hunqing.png">
				<span>婚礼策划</span>
			</a>
		</li>
		...
		<li>
			<a href="<?php echo url('home/Index/fullDress'); ?>">
	...
	<ul class="clearfix">
		...
		<li>
			<a href="__PUBLIC__/index.php/home/Hotel/hotel_xq?id=<?php echo $v['id']; ?>">
				<div class="img"><img src="__PUBLIC__/img/user/<?php echo $v['hotel_img1'];?>"></div>
	...
	<ul class="clearfix">
		...
		<li>
			<a href="bj/HunYan/MeiGuiLiTaiYang-Info">
				<div class="img"><img src="__PUBLIC__/<?php echo $v['pbusinessImg'];?>"></div>
	...
	<div class="allItemCon">
		...
		<div class="allItem allItem_2">
			<ul>
				...
				<li>
					<a href="bj/HunShaSheYing/BeiJingHanGuoYiJiang-Photo-9619">
		...
		<div class="allItem allItem_3">
			<ul>
				...
				<li>
					<a href="bj/HunQing/JinLiRen-photo-6017">
