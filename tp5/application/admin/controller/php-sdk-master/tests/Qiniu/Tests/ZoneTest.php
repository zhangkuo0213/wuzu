...
class ZoneTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUpHostByToken()
    {
        ...
        $this->assertEquals('http://uploads-z1.qiniu.com', $upHostBackup);
        $this->assertEquals(null, $err);
